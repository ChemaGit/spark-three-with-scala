...
object StructuredStreaming {
   ...
   def main(args: Array[String]) {
      ...
      val spark = SparkSession
        ...
        .master("local[*]")
        .config("spark.sql.warehouse.dir", "/home/chema/tmp") 
        .config("spark.sql.streaming.checkpointLocation", "/home/chema/IdeaProjects/spark-streaming-course/checkpoint")
        .getOrCreate()
        
      setupLogging()
        
      // Create a stream of text files dumped into the logs directory
      val rawData = spark.readStream.text("/home/chema/IdeaProjects/spark-streaming-course/logs/")
